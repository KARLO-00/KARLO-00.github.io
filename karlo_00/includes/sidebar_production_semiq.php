...
<div class="sidebar" data-color="azure" data-background-color="white" data-image="public/theme/img/sidebar-1.jpg">
    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
        <li class="nav-item">
              <b><p style="text-align: center; font-weight: 800; font-size: 13pt; margin-top: 100px;">FOR PRODUCTION:</p></b>
            </a>
          </li>
          ...
          <li class="nav-item <?php echo (($url == 'prod_sticker.php') ? '' : ''); ?>">
            <a class="nav-link" href="prod_sticker.php" style="background: #FF7F50 !important; color: #ffffff;">
              <i class="material-icons" style="color: #ffffff !important;">dashboard</i>
              <b><p>IXYS LABEL (ORACLE)</p></b>
            </a>
          </li>
          <li class="nav-item <?php echo (($url == 'semiq_sticker.php') ? 'active' : ''); ?>">
            <a class="nav-link" href="semiq_sticker.php" style="background: #9e1b32  !important; color: #ffffff;">
              <i class="material-icons" style="color: #ffffff !important;">dashboard</i>
              <b><p>SEMIQ LABEL</p></b>
            </a>
          </li>
          <li class="nav-item <?php echo (($url == '') ? 'active' : ''); ?>">
            <a class="nav-link" href="#" style="background:rgb(27, 154, 158)  !important; color: #ffffff;">
              <i class="material-icons" style="color: #ffffff !important;">dashboard</i>
              <b><p>HITACHI LABEL (soon)</p></b>
            </a>
          </li>
          <li class="nav-item <?php echo (($url == '') ? 'active' : ''); ?>">
            <a class="nav-link" href="#" style="background:rgb(189, 148, 14)  !important; color: #ffffff;">
              <i class="material-icons" style="color: #ffffff !important;">dashboard</i>
              <b><p>MICROSHIP LABEL (soon)</p></b>
            </a>
          </li>
          <br/>
          <li class="nav-item">
              <b><p style="text-align: center; font-weight: 800; font-size: 13pt;">FOR SHIPPING:</p></b>
            </a>
          </li>
          <li class="nav-item <?php echo (($url == 'shipping.php') ? '' : ''); ?>">
            <a class="nav-link" href="shipping.php" style="background: #800080 !important; color: #ffffff;">
              <i class="material-icons" style="color: #ffffff !important;">dashboard</i>
              <b><p>ODOO LABEL (SHIPPING)</p></b>
            </a>
          </li>
          <li class="nav-item <?php echo (($url == 'index.php') ? '' : ''); ?>">
            <a class="nav-link" href="index.php" style="background: #FF7F50 !important; color: #ffffff;">
              <i class="material-icons" style="color: #ffffff !important;">dashboard</i>
